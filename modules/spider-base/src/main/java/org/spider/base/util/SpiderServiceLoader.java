...
public final class SpiderServiceLoader<S> implements Iterable<S> {
	...
	private SpiderServiceLoader(Class<S> svc, ClassLoader cl) {
		service = svc;
		loader = cl;
		reload();
	}
	 ...
	 */
	public static <S> SpiderServiceLoader<S> load(Class<S> service, ClassLoader loader) {
		return new SpiderServiceLoader<S>(service, loader);
	}
	 ...
	 * @return A new service loader
	 */
	public static <S> SpiderServiceLoader<S> load(Class<S> service) {
		ClassLoader cl = Thread.currentThread().getContextClassLoader();
		return SpiderServiceLoader.load(service, cl);
	}
	 ...
	 * @return A new service loader
	 */
	public static <S> SpiderServiceLoader<S> loadInstalled(Class<S> service) {
		...
		return SpiderServiceLoader.load(service, prev);
	}
