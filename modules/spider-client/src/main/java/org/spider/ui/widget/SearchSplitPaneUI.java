...
public class SearchSplitPaneUI extends BasicSplitPaneUI {
	...
	private class MyBasicSplitPaneDivider extends BasicSplitPaneDivider {
		...
		public MyBasicSplitPaneDivider(SearchSplitPaneUI ui) {
			...
			// DefaultLookup.getBoolean(ui.getSplitPane(),
				...
				if (leftButton != null && rightButton != null) {
					if (splitPane.isOneTouchExpandable()) {
						...
						if (orientation == JSplitPane.VERTICAL_SPLIT) {
							...
							rightButton.setBounds(extraX - oneTouchOffset + oneTouchSize * 2 + width / 2, y,
							...
							rightButton.setBounds(x, extraY - oneTouchOffset + oneTouchSize * 2 + height / 2,
